...
public class FrmIngresarNombre extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        if(validar()){
            ...
            this.jugador= control.crearJugador(txtNombre.getText(), (String) cmbColor.getSelectedItem());
            FrmMenuJuego menuJuego= FrmMenuJuego.getInstance();
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        this.dispose();
        juegoTimbiriche juego= juegoTimbiriche.getInstance();
